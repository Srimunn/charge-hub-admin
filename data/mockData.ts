...
// Generate mock stations (Empty by default, user-added data is stored in backend)
...
export const mockChargingSessions: ChargingSession[] = [
  ...
  },
  {
    id: 'SES-005',
    stationId: 'STN-007',
    vehicleId: 'VEH-Hyundai-Kona-7890',
    userId: 'USR-012',
    batterySOC: 55,
    chargingPower: 9.8,
    duration: 38,
  ...
  },
  {
    id: 'SES-006',
    stationId: 'STN-008',
    vehicleId: 'VEH-Mahindra-XUV400-2345',
    userId: 'USR-015',
    batterySOC: 73,
    chargingPower: 10.5,
    duration: 52,
...
export const mockUsers: User[] = [
  ...
  },
  {
    ...
    email: 'admin@project-lithium.com',
    type: 'fleet',
    registeredAt: new Date('2023-11-05'),
    totalSessions: 892,
    totalSpent: 124506.00,
    status: 'active',
    usageLimit: 250000,
  },
  {
  ...
  {
    id: 'USR-006',
    name: 'Zepto Delivery Fleet',
    email: 'fleet-ops@zeptonow.com',
    type: 'fleet',
